...
| CN-20 | NEXT   | Transformation narrative section                   | Org-level transformation evidence for recruiter/hiring-manager persona. Anonymised archetypes ("mid-size EdTech," "enterprise team"). Proves Agile Coach practice depth — not individual coaching sales copy. Unblocked by STR-1. |
| CN-21 | LATER  | "What I'm actually working on" signal              | Market currency signal — shows active practice, not on the bench. Relevant to both recruiter (current?) and coaching-prospect (what's in scope). Run after CN-20.                                                               |
| CN-22 | LATER  | "Common starting points" recognition copy          | Problem-first framing for IC/team lead persona: "your team is shipping less and nobody knows why." Lower priority — coaching prospect is secondary persona per STR-1.                                                            |
| CN-23 | NEXT   | Credential / training badge icons                  | Visual icons for ICF, PSM, SAFe, etc. above the fold. Highest-ROI item for recruiter persona — credential scan happens in first 10 seconds before prose is read. Unblocked by STR-1.                                            |
...
| ID    | Status | Item                                                | Notes                                                                                                                                                       |
| ----- | ------ | --------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| STR-1 | DONE   | DISCOVER: who actually finds you and how            | Done 2026-05-19 — dominant channel is recruiter/hiring-manager via CV/LinkedIn. Warm referral dominates coaching enquiries. Recruiter persona formalised. See `docs/feature/str-1-acquisition-discovery/`. |
| STR-2 | LATER  | Reconsider DEF-1/2/3 with proof-of-practice framing | IDEAS.md argues thought leadership on dysfunction patterns is a discovery mechanism, not content-for-content's-sake. Run STR-1 first — now done; STR-2 unblocked but not prioritised.                    |
